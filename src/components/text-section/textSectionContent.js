export const textContent = {
      p1:{
        title: 
            ["We make ", <a className='text-selected-text'>Live </a>, <a className='text-selected-text'>Push </a>, "and " , <a className='text-selected-text'>Link </a> ," — unique software and hardware for music creation and performance. With these products, our community of users creates amazing things."],
        body:
